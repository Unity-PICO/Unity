 ...
 *        - YES：开启
 *        - NO：关闭（默认）
 * @note 该方法仅开启空间音频功能，你须调用 updatePosition:{@link #ByteRTCSpatialAudio#updatePosition:} 设置自身位置坐标后方可收听空间音频效果。空间音频相关 API 和调用时序详见[空间音频](https:
 * @list 高级功能
 * @order 8
 */
 ...
 *        - 0: 成功；
 *        - !0: 失败。
 * @note 调用该接口更新坐标前，你需调用 enableSpatialAudio:{@link #ByteRTCSpatialAudio#enableSpatialAudio:} 开启空间音频功能。空间音频相关 API 和调用时序详见[空间音频](https:
 * @list 高级功能
 * @order 11
 */
 ...
 *        - !0: 失败。
 * @note
 *        - 调用此接口前，你需调用 enableSpatialAudio:{@link #ByteRTCSpatialAudio#enableSpatialAudio:} 开启空间音频功能。
 *        - 空间音频相关 API 和调用时序详见[空间音频](https:
 * @list 高级功能
 * @order 10
 */
